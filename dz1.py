...
def check_file_plus():
    ...
    if dict1 == []:
        ...
        print('Заметки отсутствуют, занесите новые данные, либо загрузите готовый список', end='')
        print("\n________")
        show_inf(1)
        return None
    else: return dict1
...
6 - Редактировать заметку из списка\n7 - Завершить работу\n______"
    while button != "7":
        ...
        elif button == "3": display_notes()
        elif button == "4": show_filter()
